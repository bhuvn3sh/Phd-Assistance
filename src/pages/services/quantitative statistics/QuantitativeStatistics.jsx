...
function QuantitativeStatistics() {
  return (
    <>
      <Topbar />
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="about-cap ftco-animate pt-100 fadeInUp ftco-animated">
                <h2>Statistics for Your Ph.D. Research </h2>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <div className="">
                <h2 className="text-center">
                  Statistics for Your Ph.D. Research
                </h2>
                <p>
                  Are you confused in choosing the right statistics? Are you not
                  clear on what to write under results part?Then you’ve reached
                  the right place
                </p>
              </div>
            </div>
            <div className="col-md-8">
              <div className="">
                <p>
                  Statistical analysis is crucial for transforming data into
                  meaningful insights for a doctoral thesis. Ph.D. Assistance
                  offers expert statisticians to handle all aspects, from tool
                  development and data collection to analysis and
                  interpretation. Our services include using advanced
                  statistical software like AMOS, PLS, SAS, and SPSS to ensure
                  accurate and professional presentation of your data.
                </p>
                <p>
                  Ph.D. Assistance supports Ph.D. candidates for the development
                  of tools including the questionnaire, a collection of data
                  statistical analysis by also using statistical software link
                  AMOS, PLS LISTERS, SAS, SPSS software of which it is an
                  expert. Ph.D. Assistance also supports scholars by providing
                  with the latest up-to-date training courses designed by
                  professional at the center and through video conference
                  facility. Our expert statisticians will not only formulate the
                  statistical analysis for your Ph.D. paper but also clear your
                  doubts and help you in problem-solving and conduct sessions in
                  understanding the concepts of the statistical analysis.
                </p>
              </div>
            </div>
              ...
              <div className="pricing-1 pricing-animate pricing-fadeUp pricing-animated services-description">
                <div className="block-7 w-100">
                  <div className="text-center">
                    ...
                    <span className="topic-selection d-block"></span>
                    <p>
                      We use appropriate statistical tools to analyze your data,
                      format tables according to manuscript style, and interpret
                      results. Our analysis includes discussing findings in
                      relation to previous studies from your Literature Review.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 text-center">
              <h3>Statistics Features at PhD Assistance</h3>
            </div>
            <div className="col-md-4">
...
export default QuantitativeStatistics;
