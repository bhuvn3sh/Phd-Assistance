          ...
          <div className="row">
            <div className="col-md-12">
              <div className="about-cap ftco-animate pt-100 fadeInUp ftco-animated">
                <h2>Annotated Bibliography Writing Assistance</h2>
      ...
      <section className="description">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <div className="">
                <h2 className="text-center">Annotated Bibliography</h2>
                <p>
            ...
            <div className="col-md-8">
              <div className="">
                ...
                <p>
                  Most of the students are facing an extremely confused and
                  frustrated situation when collecting the references for their
                  Ph.D. dissertation Topic as it must be Well-Researched, and
                  have a very clear research goal. Both English-speaking and
                  Non-English speaking countries such as united states, United
                  Kingdom, Australia, Chinese, Brazil, Singaporeans, Malays,
                  Indonesia and other Asian country’s students are facing
                  difficulties when they are collecting the references based on
                  library catalogue, subject guides, topic wise or referencing
                  style whether it is online or offline reference collection.
                  Undoubtedly, it needs an extensive search by referencing many
                  peer-reviewed and online sources.
                </p>
              </div>
            </div>
