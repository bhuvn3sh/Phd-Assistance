          ...
          <div className="row">
            <div className="col-md-12">
              <div className="about-cap ftco-animate pt-100 fadeInUp ftco-animated">
                <h2>Econometric Modeling for Your Ph.D. Research </h2>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="">
                ...
                <p>
                  Are you looking to outsource your economic data and looking
                  for an integration of economics, mathematic economic and
                  statistics to find a relationship? Then you’ve reached the
                  right place?
                </p>
              </div>
            </div>
            <div className="col-md-8">
              <div className="">
                <p>
                  Econometrics is a discipline based on the development of
                  probabilistic models and statistical inference methods for the
                  study of economic relations. The relationship depicts the
                  random behavior of economic relationship which are not
                  considered in the mathematical and economical formulation.
                  Basically, it deals with evaluating economic theories and
                  models and investigating their validity. It consists of
                  elements from a wide range of disciplines including
                  mathematics, economics, and statistics. While, main aim of
                  econometrics is to develop models to analyse relationship
                  between variables with due regard to (a) the multi-causal
                  nature of most economic variables – non-experimental and b)
                  measurement errors.
                </p>
                <p>
                  At Ph.D. Assistance, we help you to formulate and specify
                  economic models (e.g. functional form, the specification of
                  stochastic structure), followed by estimation and testing of
                  models, and finally use models for forecasting and policy
                  formulation. Further our team of expertise has the knowledge
                  to handle both theoretical and applied econometrics (e.g.
                  demand, supply, production, investment, corruption).
                </p>
              </div>
            </div>
