          ...
          <div className="row">
            <div className="col-md-12">
              <div className="about-cap ftco-animate pt-100 fadeInUp ftco-animated">
                <h2>Content Analysis for your Ph.D. Research </h2>
      ...
      <section className="description">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <div className="">
                <h2 className="text-center">Quantitative Textual Analysis</h2>
                <p>
                  Are you confused in choosing the right tool for your
                  qualitative analysis? Are you not clear on what to write under
                  qualitative results?Then you’ve reached the right place
                </p>
              </div>
            </div>
            <div className="col-md-8">
              <div className="">
                <p>
                  Qualitative research involves interpretive techniques to
                  understand the meaning of social phenomena through
                  non-numerical data, such as interviews, videos, or images.
                  Ph.D. Assistance excels in qualitative analysis by coding and
                  analyzing data from semi-structured interviews to identify
                  common themes and ensure validity through methods like
                  triangulation and peer review. We utilize advanced software
                  tools like ATLAS.ti, NVivo, and others to manage and analyze
                  data effectively.
                </p>
                <p>
                  Our team of experts, with extensive experience from top
                  universities, applies various qualitative methodologies such
                  as grounded theory, thematic analysis, and narrative analysis.
                  We ensure meticulous planning and presentation, delivering
                  high-quality research projects well ahead of deadlines, so you
                  can be confident that your Ph.D. research is in expert hands.
                </p>
              </div>
            </div>
              ...
              >
                <div className="block-7 w-100">
                  <div className="text-center">
                    ...
                    <p>
                    Transcription of interview & coding
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pricing-1 pricing-animate pricing-fadeUp pricing-animated services-description">
                <div className="block-7 w-100">
                  <div className="text-center">
                    ...
                    <span className="topic-selection d-block"></span>
                    <p>
                    Basic + Coding along with interpretation
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pricing-1 pricing-animate pricing-fadeUp pricing-animated services-description">
                <div className="block-7 w-100">
                  <div className="text-center">
                    ...
                    <span className="topic-selection d-block"></span>
                    <p>
                    Basic + advanced and discussion based on the literature review
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 text-center">
              <h3>Quantitative Textual Analysis Features </h3>
            </div>
            <div className="col-md-4">
