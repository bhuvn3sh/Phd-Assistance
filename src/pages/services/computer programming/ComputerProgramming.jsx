          ...
          <div className="row">
            <div className="col-md-12">
              <div className="about-cap ftco-animate pt-100 fadeInUp ftco-animated">
                <h2>
                  Professional Computer Science Dissertation help {" "}
                </h2>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="">
                ...
                Ph.D. Computer Science Research mentoring at Ph.D. Assistance
                </h2>
                <p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 text-center">
              <h3>Computer Programming Features</h3>
            </div>
            <div className="col-md-4">
