          ...
          <div className="row">
            <div className="col-md-12">
              <div className="about-cap ftco-animate pt-100 fadeInUp ftco-animated">
                <h2>Engineering & Technology– Academic Writing </h2>
      ...
      <section className="description">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <div className="">
                <h2 className="text-center">Engineering & Technology Writing </h2>
                <p>
...
export default EngineeringAndTech;
