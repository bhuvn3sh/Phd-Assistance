  ...
  return (
    <div style={{ paddingTop: "50px" }}>
      <footer class="ftco-footer">
              ...
              <div class="ftco-footer-widget mb-4">
                ...
                <div class="block-23 mb-3">
                  <ul class="list-unstyled">
                    ...
                    <li>
                      <span class="#"></span>
                      <span class="fa fa-phone mr-1"></span>India:
                      +91-9176966446
                    </li>
                    <li>
                      <span class="#"></span>
                      <span class="fa fa-phone mr-1"></span>Landline:
                      +91-44-42124284( Between 9.00 am - 6.00 pm IST)
                    </li>
                    <li>
                      <span class="#"></span>
                      <span class="fa fa-phone mr-1"></span>For existing
                      clients: +91-8754446693
                    </li>
                    <li>
                      <span class="#"></span>
                      <span class="fa fa-phone mr-1"></span>Customer Care:
                      +91-9384672299
                    </li>
                    <li>
                      <span class="#"></span>
        ...
        <div class="container-fluid px-0 py-5 custom-bg">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
